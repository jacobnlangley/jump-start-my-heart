...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootcards/1.1.2/fonts/icomoon.eot">

	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootcards/1.1.2/fonts/icomoon.svg">

	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootcards/1.1.2/fonts/icomoon.woff">

	<link rel="stylesheet" href="<?= get_stylesheet_directory_uri(); ?>/dist/css/styles.css">

	<script src="<?= get_stylesheet_directory_uri(); ?>/dist/js/modernizr.js"></script>
