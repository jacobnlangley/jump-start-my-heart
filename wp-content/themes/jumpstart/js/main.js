(function ($) {
// IIFE to give us back dollar sign ($) jQuery shorthand - WP includes jQuery in the Core but in compatibility mode // to add no conflict with other libraries, MooTools, Prototype, etc
